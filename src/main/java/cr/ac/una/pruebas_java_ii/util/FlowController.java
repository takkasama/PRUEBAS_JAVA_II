...
import cr.ac.una.pruebas_java_ii.controller.Controller;
...
public class FlowController {
    ...
    private final static String PATH_FILES = "/cr/ac/una/pruebas_java_ii/";
    ...
    try {
        ...
        public void goMain(String acceso) {
            ...
            FXMLLoader loader = new FXMLLoader(
                App.class.getResource("view/" + acceso + "View.fxml"),
                this.idioma
            );
    ...
    public void goViewInWindow(String viewName) {
        ...
        //tage.getIcons().add(new Image(App.class.getResourceAsStream(PATH_FILES +"visuals/icon.png")));
    ...
    public void goViewInWindowModal(String viewName, Stage parentStage, Boolean resizable) {
        ...
        controller.initialize();
        Stage stage = new Stage();
        //stage.getIcons().add(new Image(App.class.getResourceAsStream(PATH_FILES +"visuals/icon.png")));
        stage.setTitle(controller.getNombreVista());
    ...
    private void applyIcon(Stage stage) {
        ...
        stage.getIcons().add(new Image(
                App.class.getResourceAsStream(PATH_FILES + "visuals/icon.png")
        ));
    }
